...
```leaflet  
id: BralTopside ### Must be unique with no spaces  
image: [[Rock of Bral Map.png]] ### Link to the map image file. Do not add a ! in front of the image  
